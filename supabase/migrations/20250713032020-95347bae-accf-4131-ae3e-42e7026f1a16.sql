-- Clean up existing dependencies and fix signup flow
...
DROP FUNCTION IF EXISTS public.create_social_profile() CASCADE;

-- Create the new comprehensive handle_new_user function
