      ...
      <section className="py-20 px-6 bg-secondary/10" id="benefits">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {/* Benefit 1 */}
            <div className="glassmorphism-card p-6 rounded-xl flex flex-col items-center text-center bg-white/10 backdrop-blur-sm border border-white/20">
          ...
          <div className="text-center mt-16">
            <Button 
              size="lg" 
              className="bg-primary text-white hover:bg-primary/90 transition-transform"
