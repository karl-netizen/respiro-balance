    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center px-6 pb-20 pt-32">
        <div className="glassmorphism-card max-w-lg w-full p-8 text-center">
          <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-mindflow-light flex items-center justify-center">
          ...
          <Button asChild className="bg-primary text-white hover:bg-mindflow-dark">
