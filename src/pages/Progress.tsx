...
import { ProgressHero } from "@/components/progress";
...
// Lazy load the heavy tab components
const OverviewTab = lazy(() => import("@/components/progress/OverviewTab"));
const InsightsTab = lazy(() => import("@/components/progress/InsightsTab"));
const AchievementsTab = lazy(() => import("@/components/progress/AchievementsTab"));
const CorrelationsTab = lazy(() => import("@/components/progress/CorrelationsTab"));
