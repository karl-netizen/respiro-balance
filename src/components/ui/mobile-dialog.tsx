...
>(({ className, children, ...props }, ref) => {
  ...
  const getContentClasses = () => {
    switch (deviceType) {
      case 'mobile':
        return "fixed left-[2%] right-[2%] top-[5%] bottom-[5%] z-50 grid w-auto gap-4 border bg-background p-4 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-lg overflow-auto";
      case 'tablet':
        return "fixed left-[10%] right-[10%] top-[10%] bottom-[10%] z-50 grid w-auto gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-lg overflow-auto";
      default:
...
const MobileDialogFooter = ({
  ...
  const getFooterClasses = () => {
    switch (deviceType) {
      case 'mobile':
        return "flex flex-col space-y-2 sm:flex-row sm:justify-end sm:space-x-2 sm:space-y-0";
      default:
  ...
  return (
    <div
      className={cn(getFooterClasses(), className)}
      {...props}
    />
  )
}
