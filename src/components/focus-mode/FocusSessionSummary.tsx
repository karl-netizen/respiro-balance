    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Card className="p-3">
          ...
          <p className="text-xl font-semibold">{session.taskCompleted ? "Yes" : "No"}</p>
        </Card>
        
        <Card className="p-3">
          <p className="text-xs text-muted-foreground">Distractions</p>
          <p className="text-xl font-semibold">{session.distractionCount || 0}</p>
        </Card>
      </div>
