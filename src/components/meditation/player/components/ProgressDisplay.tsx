...
const ProgressDisplay: React.FC<ProgressDisplayProps> = ({
  ...
  return (
    <div className={`space-y-2 bg-gray-900 p-4 rounded-md border border-gray-700 shadow-lg ${className}`}>
      ...
      <div className="relative h-3 w-full overflow-hidden rounded-full bg-gray-800 border border-gray-700">
        <div
